...
export default function FormUsaRenewal() {
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="formContainer">
        ...
        <div className="formSection">
          ...
          <div>
            <select
              ...
              onChange={(e) => setValue("Global Entry Renewal", e.target.value)}
              {...register("formType")}
            >
        ...
        <div className="formSection">
          ...
          <h4>
            ...
            GLOBAL ENTRY Renewal application with Global Entry Pro Assis:
          </h4>
          <h4>
