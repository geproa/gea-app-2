    ...
    <div class="max-w-screen-2xl mx-auto">
      <form onSubmit={handleSubmit(onSubmit)} className="formContainer">
        ...
        <div className="formSection">
          <div class="title-box">
            <h3 class="text-3xl text-white pb-2">NEXUS Canada Form</h3>
          </div>
          <div>
            <select
              id="formType"
              className="hidden  shadow rounded w-32 h-9  px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              onChange={(e) => setValue("NEXUS Canada Form", e.target.value)}
              {...register("formType")}
            >
              <option key="NEXUS Canada Form" value="NEXUS Canada Form">
                NEXUS Canada Form
              </option>
            </select>
